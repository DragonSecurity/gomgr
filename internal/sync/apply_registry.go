...
func buildDefaultRegistry() *HandlerRegistry {
	...
	r.Register(scopeRepoUnarchive, util.ActionEnsure, precedenceRepoUnarchive, HandlerFunc(applyRepoArchiveEnsure))
	r.Register(scopeRepoVisibility, util.ActionEnsure, precedenceRepoVisibility, HandlerFunc(applyRepoVisibilityEnsure))
	r.Register(scopeRepoArchive, util.ActionEnsure, precedenceRepoArchive, HandlerFunc(applyRepoArchiveEnsure))
