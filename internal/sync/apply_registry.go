...
func buildDefaultRegistry() *HandlerRegistry {
	...
	r.Register(scopeRepoSettings, "ensure", precedenceRepoSettingsEnsure, HandlerFunc(applyRepoSettingsEnsure))
	r.Register("repo-topics", "ensure", precedenceRepoTopicsEnsure, HandlerFunc(applyRepoTopicsEnsure))
	r.Register(scopeRepoVisibility, "ensure", precedenceRepoVisibility, HandlerFunc(applyRepoVisibilityEnsure))
